<template>
  <div class="end_container">
    <div class="alert" v-if="isdeFaultPass=='true'"><i class="el-icon-warning"></i>你是以默认密码Abcd1234登录，为保障资金安全，请立即
      <el-button type=text @click="gotoset">修改密码</el-button>
    </div>
    <div class="end_top">
      <div class="top_left">
        <p>总资产折合: <b>{{wallterDetail.total | numFormat}}</b> ≈ <span>{{wallterDetail.total | numFormat}}</span></p>
    ...
    <div class="end_bottom">
      <div class="end_filter">
        <el-form :model="searchForm" :inline="true" :rules="rules" ref="ruleForm" label-width="80px"
                 class="demo-ruleForm">
    ...
    <el-dialog
      ...
      <iframe :src="getBindurl" width="100%" height="500" frameborder="0" scrolling="no"
      ></iframe>
    </el-dialog>
    <el-dialog
      title="提币"
      :visible.sync="coinType" width="40%">
